...
2^0 = 1 conditions = existence(2 modes, 0 bit), max=0
2^1 = 2 conditions (2 modes, 1 bit), max=1
2^2 = 4 conditions (2 modes, 2 bit), max=3
2^3 = 8 conditions (2 modes, 3 bit), max=7
